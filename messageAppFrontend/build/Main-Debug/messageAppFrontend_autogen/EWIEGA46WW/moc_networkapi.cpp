/****************************************************************************
** Meta object code from reading C++ file 'networkapi.h'
**
...
#error "The header file 'networkapi.h' doesn't include <QObject>."
...
void ApiClient::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->messageReceived((*reinterpret_cast<std::add_pointer_t<QJsonArray>>(_a[1]))); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (ApiClient::*)(const QJsonArray & )>(_a, &ApiClient::messageReceived, 0))
            return;
    }
}
...
// SIGNAL 0
void ApiClient::messageReceived(const QJsonArray & _t1)
{
